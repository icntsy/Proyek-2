              ...
              <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
                    ...
                    <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK"></div>
                    ...
                    <div class="col-sm-6 col-md-5 col-lg-6">
                        <label for="kewarganegaraan" class="form-label">Kewarganegaraan</label>
                          <input type="text" class="form-control" id="kewarganegaraan" name="kewarganegaraan"  placeholder="Kewarganegaraan"></div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-5 col-lg-6"><label for="pekerjaan" class="form-label">Pekerjaan</label>
                      ...
                      <input type="text" class="form-control" id="status_kawin" name="status_kawin" placeholder="status_kawin"></div>
